    ...
    return (
        <View style={[styles.fullScreen,styles.centerHorizontal,{backgroundColor:'#2A3139'}]}>
          ...
          <View style={{justifyContent:'center',flex:1}}>
              ...
              <Text style={{color:'#fff',fontSize:20,marginLeft:20,marginRight:20,textAlign:'center'}}>Our community is verfiying each other. No facebook, no worries, we’ll simply verify you with some contacts who know you. it only takes 2 min. {"\n"}{"\n"}how should we call you?</Text>
              <View style={{marginLeft:20,marginRight:20,marginTop:20}}>
                ...
                <View style={{backgroundColor:'#121518',height:50,marginTop:10,borderRadius:10,paddingLeft:10,paddingRight:10}}>
                    <TextInput style={{color:'rgba(236, 211, 255, 0.63)',flex:1}} value={this.state.first_name}></TextInput>
                </View>
              </View>
              <View style={{marginLeft:20,marginRight:20,marginTop:20}}>
                <Text style={{fontSize:16,color:'#D19FF8'}}>Last Name</Text>
                <View style={{backgroundColor:'#121518',height:50,marginTop:10,borderRadius:10,paddingLeft:10,paddingRight:10}}>
                    <TextInput style={{color:'rgba(236, 211, 255, 0.63)',flex:1}} value={this.state.last_name}></TextInput>
                </View>
              </View>
